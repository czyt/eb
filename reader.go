...
type ReaderBind interface {
	Read(option *ReaderOption)
}
...
func Read[T ReaderBind](reader io.Reader, bind T, filterFunc ...func(t T) (add bool)) ([]T, error) {
...
//
// params: filterFunc, filter callback func
func ReadFile[T ReaderBind](file string, bind T, filterFunc ...func(t T) (add bool)) ([]T, error) {
...
//
// params: filterFunc, filter callback func
func ReadBinary[T ReaderBind](bytes []byte, bind T, filterFunc ...func(t T) (add bool)) ([]T, error) {
